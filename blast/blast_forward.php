...
$result_f = $_SESSION['result_f_complete'];
...
<html>
	...
	<body class="subpage">
		...
		<section id="two" class="wrapper">
            ...
            <h2>Result Forward</h2>
            <div id="blast-multiple-alignments-f"></div>
            <div id="blast-alignments-table-f"></div>
            <div id="blast-single-alignment-f"></div>

<?php $file_f = file_get_contents($result_f);
    $file_f = str_replace("\n", '\n', str_replace('"', '\"', addcslashes(str_replace("\r", '', (string)$file_f), "\0..\37'\\")));
?>

    <script type="text/javascript">
        var alignments = "<?php echo $file_f; ?>";
